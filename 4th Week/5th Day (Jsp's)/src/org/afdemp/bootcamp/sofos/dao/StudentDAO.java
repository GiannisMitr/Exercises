...
public class StudentDAO {
	...
	public void open() throws SQLException {
		...
		try {
			...
			// object (con)
			con = DriverManager.getConnection("jdbc:mysql://localhost:3306/bootcamp", "root", "alajp321");
		} catch (Exception e) {
			con = null;
	...
	public Student findStudentByAM(String am) throws Exception {
		...
		try {
            ...
            String sql= "SELECT * FROM student_table where student_table.am=?";
			...
			if(rs.next()){
				return new Student(rs.getString("name"), rs.getString("surname"), rs.getString("am"));
